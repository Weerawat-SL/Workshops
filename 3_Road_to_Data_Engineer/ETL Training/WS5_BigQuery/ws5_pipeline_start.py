...
dag = DAG(
    'ws5_online_retail_DB_API_Merge_BigQuery',
...
t4 = BashOperator(
    task_id='toBigQuery',
    bash_command='bq load --source_format=CSV --autodetect ws5BigQuery.Online_retail2 gs://australia-southeast1-ws4air-e05b9879-bucket/data/result.csv',
    dag=dag,
)
